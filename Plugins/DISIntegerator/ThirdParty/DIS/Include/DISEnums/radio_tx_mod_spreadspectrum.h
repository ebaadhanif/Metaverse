...
namespace radio_tx_mod_spreadspectrum {
	...
	class EXPORT_MACRO FrequencyHopping : public Enumeration {
  public:
	...
	class EXPORT_MACRO Pseudo_noise : public Enumeration {
  public:
	...
	class EXPORT_MACRO TimeHopping : public Enumeration {
  public:
