...
class EXPORT_MACRO ArticulatedPartsOffsetNumber : public Enumeration {
  public:
	...
	//Added by Farhan, not found in the SISO Enumerations standard document, using last value of 31 for Quantity
	static ArticulatedPartsOffsetNumber QUANTITY;
