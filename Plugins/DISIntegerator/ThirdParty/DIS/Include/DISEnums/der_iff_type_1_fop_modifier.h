...
namespace der_iff_type_1_fop_modifier {
	...
	class EXPORT_MACRO Other : public Enumeration {
  public:
	...
	class EXPORT_MACRO Emergency : public Enumeration {
  public:
	...
	class EXPORT_MACRO Ident_SquawkFlash : public Enumeration {
  public:
	...
	class EXPORT_MACRO STI : public Enumeration {
  public:
