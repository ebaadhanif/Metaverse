#ifndef ES_APPEAR_PLATFORM_SPACE__H
#define ES_APPEAR_PLATFORM_SPACE__H
...
namespace es_appear_platform_space {
...
#endif /* ES_APPEAR_PLATFORM_SPACE__H */
