#ifndef DER_IFF_TYPE_2_FOP_PARAM6__H
#define DER_IFF_TYPE_2_FOP_PARAM6__H
...
namespace der_iff_type_2_fop_param6 {
	...
	class EXPORT_MACRO TCAS : public Enumeration {
  public:
    static TCAS TCAS_I;
    static TCAS TCAS_II;
		...
		static TCAS getEnumerationForValue(int aVal) throw(EnumException);

		/** Returns true if there is an enumerated instance for this value, false otherwise. */
		static bool enumerationForValueExists(int aVal);

		typedef hashMap<int,TCAS*> enumContainer;
	...
	private:
		/** Constructor */
		TCAS(int value, std::string description);

		static TCAS* findEnumeration(int aVal);
	...
	class EXPORT_MACRO Status : public Enumeration {
  public:
    static Status OFF;
    static Status ON;
  ...
  public:
	...
	class EXPORT_MACRO Malfunction : public Enumeration {
  public:
...
#endif /* DER_IFF_TYPE_2_FOP_PARAM6__H */
