...
namespace simman_stop_frozenbehavior {
	...
	class EXPORT_MACRO Simulationclock : public Enumeration {
  public:
	...
	class EXPORT_MACRO TransmitPDUs : public Enumeration {
  public:
	...
	class EXPORT_MACRO ReceivePDUs : public Enumeration {
  public:
