#ifndef FireTypeIndicator__H
#define FireTypeIndicator__H
...
class EXPORT_MACRO FireTypeIndicator : public Enumeration {
  public:
    ...
    FireTypeIndicator& operator=(const int& aVal) throw(EnumException);
