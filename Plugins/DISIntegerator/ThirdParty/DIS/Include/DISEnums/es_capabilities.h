...
namespace DIS {
	namespace ENUMS {
		...
		namespace es_capabilities {
			...
			class EXPORT_MACRO AmmunitionSupply : public Enumeration {
			public:
			...
			class EXPORT_MACRO FuelSupply : public Enumeration {
			public:
			...
			class EXPORT_MACRO Recovery : public Enumeration {
			public:
			...
			class EXPORT_MACRO Repair : public Enumeration {
			public:
			...
			class EXPORT_MACRO ADS_B : public Enumeration {
			public:
