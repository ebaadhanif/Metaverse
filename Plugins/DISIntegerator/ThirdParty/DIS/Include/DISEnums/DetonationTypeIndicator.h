#ifndef DetonationTypeIndicator__H
#define DetonationTypeIndicator__H
...
class EXPORT_MACRO DetonationTypeIndicator : public Enumeration {
  public:
    ...
    DetonationTypeIndicator& operator=(const int& aVal) throw(EnumException);
