...
namespace env_obj_appear_point_burst {
	...
	class EXPORT_MACRO Opacity : public Enumeration {
  public:
	...
	class EXPORT_MACRO Size : public Enumeration {
  public:
	...
	class EXPORT_MACRO Height : public Enumeration {
  public:
	...
	class EXPORT_MACRO NumofBursts : public Enumeration {
  public:
	...
	class EXPORT_MACRO Chemical : public Enumeration {
  public:
