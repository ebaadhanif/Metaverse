#ifndef ENV_OBJ_MOD_POINT__H
#define ENV_OBJ_MOD_POINT__H
...
namespace env_obj_mod_point {
	...
	class EXPORT_MACRO Location : public Enumeration {
  public:
	...
	class EXPORT_MACRO Orientation : public Enumeration {
  public:
